...
VERSION ?= 0.0.1
IMAGE_TAG_BASE ?= unict.it/k8s-topology-operator
...
## marker
	cat target/kubernetes/topologies.unict.it-v1alpha1.yml target/kubernetes/kubernetes.yml | operator-sdk generate bundle -q --overwrite --version 0.1.1 --default-channel=stable --channels=stable --package=k8s-topology-operator
